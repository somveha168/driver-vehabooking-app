...
void main() {
  ...
  testWidgets('fires onConfirmed when dragged to the end', (tester) async {
    ...
    await tester.drag(find.byIcon(IconsaxPlusLinear.arrow_right_3), const Offset(500, 0));
  ...
  testWidgets('does not confirm on a short partial drag', (tester) async {
    ...
    await tester.drag(find.byIcon(IconsaxPlusLinear.arrow_right_3), const Offset(40, 0));
    await tester.pumpAndSettle();
